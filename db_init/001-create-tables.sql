...
CREATE INDEX IF NOT EXISTS idx_visit_patient_doctor ON PATIENT_VISIT(patient_id, doctor_id);
CREATE INDEX IF NOT EXISTS idx_visit_status ON PATIENT_VISIT(status);